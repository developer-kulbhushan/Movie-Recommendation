...
class PineconeManager:
    ...
    def query_index(self, user_query, top_k=5):
        dense_index = self.pinecone_client.Index(self.index_name)
        ...
        for hit in search_results['result']['hits']:
                query_results.append(f"id: {hit['_id']:<5} | score: {round(hit['_score'], 2):<5} | text: {hit['fields']['movie_data']:<50}")
